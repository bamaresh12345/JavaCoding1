...
public class RemoveDuplicatesFromSortedArray11Leetcode80 {
    ...
    public static int removeDuplicatesFromSortedArrayII(int[] nums) {
        ...
        1. declare i=0 which points to 1st element of array
        2. run for each loop till end of array for(int n : nums)
        3. check if i < 2 or n not equal to nums[i-2] then
        4. then assign nums[i] = n
        5. incrment i
        6. after enf of the loop
        7. return i, which contains the index of the element
         */
//=================GOOD ONE============================================
        int i = 0;
        for (int n : nums) {
